  ...
  work: [
    {
      ...
      logoUrl:
        "https://connect-assets.prosple.com/cdn/ff/TeQuWddSTfkBR9YxU-3FxSONN6CA9Gj3fWXKpsKavHo/1729761961/public/styles/scale_and_crop_center_224x224/public/2024-10/hooli_software_logo.jpeg?itok=xIXHXx6F",
      start: "Dec 2024",
      end: "Mar 2025",
      description:
        "Developed and maintained SnaptoApp, a Progressive Web Application (PWA) no-code web generator built with React, PostgreSQL, and Go. Debugged and optimized full-stack functionality across the system, improving stability and performance. Designed responsive UI components, implemented new features, and resolved 40+ JIRA tickets involving bugs, API issues, and UI/UX fixes. Documented all repositories and implemented server-side rendering (SSR) using the Vite SSR plugin for the generated mobile repository to enable dynamic metadata and improve SEO. Collaborated in an agile environment with a focus on clean, scalable code.",
    },
  ],
  education: [
    {
      ...
      logoUrl:
        "https://upload.wikimedia.org/wikipedia/en/e/e6/Seal_of_Holy_Angel_University.png",
      start: "2021",
      end: "2025",
    },
  ],
